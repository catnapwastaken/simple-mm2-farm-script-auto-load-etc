...
queue_on_teleport('loadstring(game:HttpGet("https://raw.githubusercontent.com/catnapwastaken/simple-mm2-farm-script-auto-load-etc/refs/heads/main/auto_rejoin_main_script.lua"))()')
